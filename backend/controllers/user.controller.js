...
export const getSuggestedUsers = async (req, res) => {
  try {
    ...
    filteredUsers.slice(0, 4).forEach((user) => (user.password = null));
    ...
    // const suggestedUsers = users.slice(0, 4).map((user) => (user.password = null));
...
export const followUnfollowUser = async (req, res) => {
  try {
    ...
    console.log(id, req.user._id, req.user._id.toString());
